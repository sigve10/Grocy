                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Great product! I love it!", // Review or description text
                                  style: Theme.of(context).textTheme.bodyMedium,
                                ),
                                  ...
                                  children: List.generate(5, (starIndex) {
                                    return Icon(
                                      starIndex < (ratings[index]['value'] as double).round()
                                          ? Icons.star
                                          : Icons.star_border, // Use star_border for hollow stars
                                      size: 20,
                                      color: Colors.amber, // Keep the color amber for both filled and hollow stars
                                    );
                                  }),
                                ),
                              ],
